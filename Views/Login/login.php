                        ...
                        <div class="text-center mt-sm-5 mb-4 text-white-50">
                            <div>
                                ...
                                <a href="index.html" class="d-inline-block auth-logo">
                                    <img src="public/images/logo-login.svg" alt="" height="130">
                                </a>
                            </div>
                        ...
                        <div class="card mt-4">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center mt-2">
                                    <h5 class="text-header">Bienvenido de nuevo !</h5>
                                    <p class="text-muted"><b>Acceder a Cave</b></p>
                                </div>
                                <div class="p-2 mt-4">
