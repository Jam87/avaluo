<!--MODAL BANCOS-->
<div id="modalDepartamentos" class="modal zoomIn" tabindex="-1" aria-hidden="true" style="display: none;">
        ...
        <div class="modal-content border-0 overflow-hidden">
            ...
            <div class="modal-body">
                <form method="post" id="formDepartamento" name="formDepartamento">
                    ...
                    <div class="mb-3">
                        <label for="Description" class="form-label">Departamento</label>
                        <input type="text" class="form-control" id="txtName" name="txtName" placeholder="Escriba un departamento" required>
                    </div><!--Fin description-->
                    <div class="mb-3">
