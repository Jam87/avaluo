...
document.addEventListener("DOMContentLoaded", function () {
  ...
  tableMarcas = $("#table-marcas").dataTable({
    aProcessing: true,
    aServerSide: true,
    language: {
    ...
    ajax: {
      url: " " + base_url + "/Avaluo/getTipoAvaluo",
      dataSrc: "",
    },
    columns: [
      { "width": "5%", data: "descripcion" },
      { "width": "5%", data: "estado" },
...
let comboxTipo = document.querySelector("#tipo");
...
function openModal() {
  ...
  document.querySelector("#titleModal").innerHTML =
    "<span class='title-modal'>Nueva marca</span>";
  document
    .querySelector(".modal-header")
