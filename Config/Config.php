...
const NOMBRE_EMPESA = "Cave-SA";
const WEB_EMPRESA = "cave-sa.com";

//Datos Empresa
const DIRECCION = "Altos de Villa Fontana, del Club Terraza 2 km al Sur, Qta Betulia. Managua.";
const TELEMPRESA = "22786819";
const CELULARMOV = "88869935";
const CELULARCLARO = "87462019";
const EMAIL_EMPRESA = " agomez@cave-sa.com";
