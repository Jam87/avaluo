...
class Departamentos extends Controllers
{
    ...
    public function Departamentos()
    {
        ...
        #Data modal
        $data['page_title_modal'] = "Nuevo departaemento";
    ...
    ### CONTROLADOR: MOSTRAR TODOS DEPARTAMENTOS ###
    public function getDepartamentos()
    {
        ...
        for ($i = 0; $i < count($arrData); $i++) {
            ...
            $arrData[$i]['options'] = '<div class="text-center">
				<button type="button" class="btn btn-warning btn-sm" onClick="fntEditDep(' . $arrData[$i]['idDep'] . ')" title="Editar"><i class="ri-edit-2-line"></i></button>
				<button type="button" class="btn btn-danger btn-sm" onClick="fntDelDep(' . $arrData[$i]['idDep'] . ')" title="Eliminar"><i class="ri-delete-bin-5-line"></i></button>
				</div>';
        }
