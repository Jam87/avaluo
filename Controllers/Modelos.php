    ...
    public function Modelos()
		{
			...
			$data['page_title'] = "Listado de modelos";
    ...
    public function getModelos()
    {
        ...
        for ($i = 0; $i < count($arrData); $i++) {
            ...
            $arrData[$i]['options'] = '<div class="text-center">
				<button type="button" class="btn btn-warning btn-sm btnEditTipo" onClick="fntEditModelo(' . $arrData[$i]['idmodelo'] . ')" title="Editar"><i class="ri-edit-2-line"></i></button>
				<button type="button" class="btn btn-danger btn-sm btnDelTipo" onClick="fntDelModelo(' . $arrData[$i]['idmodelo'] . ')" title="Eliminar"><i class="ri-delete-bin-5-line"></i></button>
				</div>';
