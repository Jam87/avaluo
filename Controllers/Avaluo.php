...
class Avaluo extends Controllers
{
    ...
    {
        $data['page_title'] = "Cave | Todo en avaluo ";
        ...
        #Data modal
        $data['page_title_modal'] = "Nuevo tipo de avaluo";
        ...
        $this->views->getView($this, "avaluo", $data);
    }
    ...
    ### CONTROLADOR: MOSTRAR TODOS TIPOS DE AVALUOS ###
    public function getTipoAvaluo()
    {
        #Cargo el modelo(selectBancos) 
        $arrData = $this->model->selectTavaluo();
