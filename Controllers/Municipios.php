...
class Municipios extends Controllers
{
    ...
    ### CONTROLADOR: MOSTRAR TODAS LOS MUNICIPIOS ###
    public function getMunicipios()
    {
        ...
        for ($i = 0; $i < count($arrData); $i++) {
            ...
            $arrData[$i]['options'] = '<div class="text-center">
				<button type="button" class="btn btn-warning btn-sm" onClick="fntEditMunic(' . $arrData[$i]['idMun'] . ')" title="Editar"><i class="ri-edit-2-line"></i></button>
				<button type="button" class="btn btn-danger btn-sm" onClick="fntDelMunic(' . $arrData[$i]['idMun'] . ')" title="Eliminar"><i class="ri-delete-bin-5-line"></i></button>
				</div>';
        }
