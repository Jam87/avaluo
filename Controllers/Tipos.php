...
class Tipos extends Controllers
{
    ...
    public function Tipos()
    {
        ...
        #Data modal
        $data['page_title_modal'] = "Nuevo tipo de rol";
    ...
    public function getTipos()
    {
        ...
        for ($i = 0; $i < count($arrData); $i++) {
            ...
            $arrData[$i]['options'] = '<div class="text-center">
				<button type="button" class="btn btn-warning btn-sm btnEditTipo" onClick="fntEditTipo(' . $arrData[$i]['idrol'] . ')" title="Editar"><i class="ri-edit-2-line"></i></button>
				<button type="button" class="btn btn-danger btn-sm btnDelTipo" onClick="fntDelTipo(' . $arrData[$i]['idrol'] . ')" title="Eliminar"><i class="ri-delete-bin-5-line"></i></button>
				</div>';
        }
